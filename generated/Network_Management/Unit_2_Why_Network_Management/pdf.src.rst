...
* Impact on the library or library mediated information
  * Slow or no access to information resources
  * Restriction on services that the library can offer
* Limited bandwidth is being used to access all sources of information
  * Not just formal, quality controlled resources

Comparison: a library with a very small door, that only allows a small
